# 09 · Drill — CISO Architecture Review Simulation
...
- Practice the ciso architecture review simulation conversation under skeptical questioning.
- State the risk, the control, the residual risk, and the decision owner.
- Avoid the Lean-No move of claiming risk is eliminated.
