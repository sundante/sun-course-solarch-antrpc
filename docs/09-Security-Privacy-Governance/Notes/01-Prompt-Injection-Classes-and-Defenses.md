# 09 · Note — Prompt Injection Classes and Defenses
...
- Explain direct, indirect, retrieval-borne, tool-borne, and cross-session injection threats for Claude deployments in BFSI.
