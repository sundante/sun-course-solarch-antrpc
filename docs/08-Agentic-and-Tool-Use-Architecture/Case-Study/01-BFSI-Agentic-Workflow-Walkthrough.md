# 08 · Case Study — BFSI Agentic Workflow Walkthrough
...
- Walk through an end-to-end RM copilot or compliance review workflow.
- Show planning, tool calls, state updates, human approvals, observability, and refusal paths.
- Make every customer-impacting action explicit and reviewable.
