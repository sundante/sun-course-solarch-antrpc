# 06 · Drill 03 — Translate a Customer KPI into an Eval
...
- Turn an executive KPI into measurable model/system eval criteria.
- Separate business KPI, model-quality metric, workflow metric, and safety metric.
- State the acceptance threshold and the regression gate.
