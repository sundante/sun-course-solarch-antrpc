# 12 · Drill — Mock Recruiter Screen
...
- Run the mock recruiter screen as a timed simulation.
- Capture transcript notes, grade against Strong Hire / Hire / Lean No / Strong No, and write one improvement loop.
- Use the BFSI running case and Claude artifact as proof points.
