# 05 · System Design — Executive Analytics Assistant
...
- Design a BFSI natural-language analytics over governed warehouse data with metric definitions and cost guardrails.
