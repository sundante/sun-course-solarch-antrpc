# 05 · System Design — Customer Support Agent Assist
...
- Design a BFSI agent desktop copilot with policy retrieval, suggested response drafting, sentiment escalation, and audit trails.
