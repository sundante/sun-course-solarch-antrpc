# 05 · Drill 02 — Cross-Architecture Pattern Recognition
...
- Compare the six BFSI system designs and identify the reusable architecture moves.
- Name the components that should be shared versus specialized per use case.
- Defend one divergence that looks inefficient but is required by risk, latency, or governance.
