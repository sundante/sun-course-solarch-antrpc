# 05 · Case Study — Six Use-Case Meta-Pattern
...
- Map the six BFSI use cases to common orchestration, retrieval, eval, security, and rollout patterns.
- Show where support assist, SOP search, RM copilot, compliance review, Claude Code, and analytics intentionally diverge.
- Use this as the comparison page before reading individual SystemDesigns.
