# 07 · Drill — RAG vs Fine-Tune vs Long-Context
...
- Practice the rag vs fine-tune vs long-context conversation for a regulated BFSI customer.
- Produce a timed answer, the architecture/eval artifact, and a Strong-Hire self-grade.
- Identify the common Lean-No mistake: sounding like RAG is a feature rather than a governed system.
