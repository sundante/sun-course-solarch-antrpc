# 11 · Drill — Same Story, Five Registers
...
- Practice same story, five registers with a timer and a skeptical interviewer.
- Write the raw answer, grade it against clarity, honesty, and audience fit.
- Repeat until the answer preserves depth without sounding like a lecture.
